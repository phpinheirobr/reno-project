...
public class JpaUtil {
	...
	/**
	 * Reno durante a execução do projeto é possível trabalhar com várias sessões com o banco de dados. Na JPA a sessão com o banco é representa pelo componente EntityManager.
	 * 
...
/*	static {
		try {
			...
			// log.error("Não conseguiu carregar a EntityManagerFactory: " +
			// ex.getMessage());
