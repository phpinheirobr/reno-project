...
import com.renostarter.infra.model.Filter;
import com.renostarter.model.Car;
import com.renostarter.service.CarService;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.renostarter.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.renostarter.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.renostarter.infra.model.SortOrder.DESCENDING
                            : com.renostarter.infra.model.SortOrder.UNSORTED;
                }
